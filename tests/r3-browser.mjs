...
try {
  ...
  check('station layout and toilet entry points remain',await page.locator('#map-layout').isVisible()&&await page.locator('#map-find-toilet').isVisible());
  ...
  await page.locator('[data-open]').click();await page.locator('[data-time=depart-later]').click();await page.locator('[name=date]').fill('2026-09-21');await page.locator('[name=departureTime]').fill('10:00');await page.locator('#find-routes').click();await page.locator('#review-route').click();await page.locator('#start-companion').click();
