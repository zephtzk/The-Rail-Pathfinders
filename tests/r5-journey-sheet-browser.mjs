...
try{
 ...
 await handle.press('End');check('320px large-text compact handle stays usable above navigation',await handle.evaluate(e=>{const r=e.getBoundingClientRect(),n=document.querySelector('.app-nav').getBoundingClientRect();return r.height>=24&&r.bottom<=n.top+1&&r.top>=76;}));await capture('compact-320-large');
