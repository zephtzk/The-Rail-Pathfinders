...
// The only shipped dependency is Leaflet. Reuse its locked installed bytes;
...
const report={recordedAt:new Date().toISOString(),sourceCommit,node:process.version,zlib:process.versions.zlib,status:'PASS',scope:'Clean Git archive build using the same locked installed Leaflet and Node/zlib runtime; not a Linux runtime execution or fresh registry install',records};
