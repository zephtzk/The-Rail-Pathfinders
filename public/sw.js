...
const SHELL=['/','/index.html','/replay.html','/icon.svg','/manifest.webmanifest','/src/rail-ui.js','/src/rail.css','/src/rail-engine.js','/data/rail-network.json','/data/rail-manifest.json','/src/app.js','/src/styles.css','/src/engine.js','/src/data.js','/src/storage.js','/src/live-data.js','/src/live-ui.js','/vendor/leaflet.js','/vendor/leaflet.css','/data/corridor.json','/data/sources.json'];
