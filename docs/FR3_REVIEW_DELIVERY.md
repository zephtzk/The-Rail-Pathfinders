...
Public version 9 succeeded on 19 September 2026 at 06:18 UTC (14:18 SGT), from merged PR #13 and source `adc5f87f0932a5c42c1212d20f5943c0e2c1ce1b`. The native database overview confirms `SHARING_DB` and `sharing_state`. Production API checks and all 14 recipient-link browser checks passed, including consent, reload, revocation and deletion. Both synthetic production shares were removed. [Second publication receipt](evidence/fr3-review/stage2-publication.json).
