...
| Broader bus coverage | All 5,208 source stops and 798 route directions across 602 exact service numbers are retained. 776 directions / 583 services / 5,206 stops have routing estimates. Source sequence gaps, nonzero distance origins, loop metadata differences and short/peak spans no longer remove whole routes. Same-code terminal changes use a five-minute estimated walking allowance. The snapshot remains valid 18 September-2 October 2026; 22 directions without headways remain listed without timing estimates. See [current audit](R5_BUS_COVERAGE.md). |
