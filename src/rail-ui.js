...
function shell() {
  app.innerHTML = `<header class="rail-header"><a class="rail-brand" href="/"><img src="/icon.svg" width="36" height="36" alt=""><span>Commute <strong>Copilot</strong></span></a><a class="replay-link" href="/replay.html">Original corridor replay <span aria-hidden="true">↗</span></a></header>
    ...
    <main id="main"><div class="rail-heading"><div><p class="eyebrow">YOUR NEXT CONNECTION</p><h1>Across the rail network.</h1><p>Choose your stations. Find a journey that fits your day.</p></div><a class="coverage-shortcut" href="#coverage">View validated coverage <span aria-hidden="true">↓</span></a></div>
