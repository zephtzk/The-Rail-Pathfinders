...
export function mountDemoIncidents({host,getNetwork=()=>null,getDate=()=>null,onNormal,page=false}={}){
  ...
  function render({focus=true}={}){
    ...
    if(form){
      form.elements.scope.onchange=()=>{const group=form.querySelector('#demo-segment-fields');group.hidden=group.disabled=form.elements.scope.value==='service';};
